        ...
        uploaded: [
          {
            ...
            url: '/recalls/abc-456/documents/3fa85f64-5717-4562-b3fc-2c963f66afa6',
            version: 2,
            createdDateTime: '2020-04-01T12:00:00.000Z',
            createdByUserName: 'Arnold Caseworker',
            label: 'Licence',
        ...
        uploaded: [
          {
            ...
            type: 'document',
            url: '/recalls/abc-456/documents/1234-8766-2344-5342',
          },
        ],
      },
      {
        ...
        uploaded: [
          {
            ...
            documentId: '2345-65434-3455-23432',
            fileName: 'other doc 1.pdf',
            url: '/recalls/abc-456/documents/2345-65434-3455-23432',
            createdByUserName: 'Arnold Caseworker',
            createdDateTime: '2020-04-01T12:00:00.000Z',
            label: 'Other',
            type: 'document',
  ...
  it('returns data on generated documents', () => {
    expect(results.documentsGenerated).toEqual({
      DOSSIER: {
        ...
        fileName: 'BADGER BOBBY 123 RECALL DOSSIER.pdf',
        type: 'generated',
        url: '/recalls/abc-456/documents/848',
        createdByUserName: 'Arnold Caseworker',
        createdDateTime: '2020-04-01T12:00:00.000Z',
      },
      LETTER_TO_PRISON: {
        ...
        fileName: 'BADGER BOBBY 123 LETTER TO PRISON.pdf',
        type: 'generated',
        url: '/recalls/abc-456/documents/838',
        createdByUserName: 'Arnold Caseworker',
        createdDateTime: '2020-04-01T12:00:00.000Z',
      },
      REASONS_FOR_RECALL: {
        ...
        fileName: 'BADGER BOBBY 123 REASONS FOR RECALL.pdf',
        type: 'generated',
        url: '/recalls/abc-456/documents/858',
        createdByUserName: 'Arnold Caseworker',
        createdDateTime: '2020-04-01T12:00:00.000Z',
      },
      RECALL_NOTIFICATION: {
        ...
        fileName: 'IN CUSTODY RECALL BADGER BOBBY 123.pdf',
        type: 'generated',
        url: '/recalls/abc-456/documents/828',
        createdByUserName: 'Arnold Caseworker',
        createdDateTime: '2020-04-01T12:00:00.000Z',
      },
      REVOCATION_ORDER: {
        ...
        fileName: 'BADGER BOBBY 123 REVOCATION ORDER.pdf',
        type: 'generated',
        url: '/recalls/abc-456/documents/868',
        createdByUserName: 'Arnold Caseworker',
        createdDateTime: '2020-04-01T12:00:00.000Z',
      },
    })
  ...
  it('returns data on uploaded emails', () => {
    expect(results.emailsUploaded).toEqual({
      DOSSIER_EMAIL: {
        ...
        fileName: 'dossier.msg',
        documentId: '37423-2389347-234',
        url: '/recalls/abc-456/documents/37423-2389347-234',
        createdByUserName: 'Arnold Caseworker',
        createdDateTime: '2020-04-01T12:00:00.000Z',
      },
      MISSING_DOCUMENTS_EMAIL: {
        ...
        type: 'email',
        url: '/recalls/abc-456/documents/845',
      },
      NSY_REMOVE_WARRANT_EMAIL: {
        ...
        type: 'email',
        url: '/recalls/abc-456/documents/639',
      },
      RESCIND_DECISION_EMAIL: {
        ...
        type: 'email',
        url: '/recalls/abc-456/documents/6543',
      },
      ...
      RESCIND_REQUEST_EMAIL: {
        ...
        type: 'email',
        url: '/recalls/abc-456/documents/1234-3455-8542-c3ac-543435',
      },
    })
  })
