...
describe('formatNsyWarrantEmailLink', () => {
  it('returns a formatted link', () => {
    ...
    expect(link).toEqual(
      'mailto:test@domain.com?subject=RTC%20-%20Dave%20Smith%20-%20A123456&body=Please%20note%20that%20Dave%20Smith%20-%2028%20May%201999%2C%20CRO%20-%20345345%2C%20Booking%20number%20-%20A123456%20-%20was%20returned%20to%20Kennet%20(HMP)%20on%2022%20January%202022%20at%2013%3A45.%20Please%20remove%20them%20from%20the%20PNC%20if%20this%20has%20not%20already%20been%20done.'
    )
  })
})
