...
this.LogRocket = (function (e) {
    ...
    ;(e.exports = function (e, t) {
      ...
      if (Object.getOwnPropertySymbols) {
        ...
        for (o = 0; o < u.length; o++)
          (n = u[o]), t.indexOf(n) >= 0 || (Object.prototype.propertyIsEnumerable.call(e, n) && (i[n] = e[n]))
      }
      return i
    }),
      (e.exports.default = e.exports),
          ...
          (XMLHttpRequest = function (e, f) {
            ...
            d &&
              ((p.open = function () {
                ...
                try {
                  var r = t[1]
                  if (window.URL && 'function' == typeof window.URL && 0 === r.search(a.WOOTRIC_RESPONSES_REGEX)) {
                    var o = new window.URL(l.recordingURL)
                    o.searchParams.set('nps', 'wootric')
                    var i = new window.URL(r),
                      u = i.searchParams.get('response[text]'),
                      c = u ? ''.concat(u, '\n\n') : ''
                    i.searchParams.set('response[text]', ''.concat(c, '<').concat(o.href, '|View LogRocket session>')),
                      (t[1] = i.href)
                  }
                } catch (e) {}
              ...
              (p.send = function () {
                ...
                try {
                  ...
                  if (
                    ...
                    r &&
                    r.url &&
                    0 === r.url.search(a.DELIGHTED_RESPONSES_REGEX) &&
                    t.length &&
                    -1 !== t[0].indexOf(a.DELIGHTED_FEEDBACK_PREFIX)
                  ) {
                    var o = new window.URL(l.recordingURL)
                    ...
                    var i = encodeURIComponent(o.href),
                      c = t[0]
                        .split('&')
                        .map(function (e) {
                          if ((0, u.default)(e, a.DELIGHTED_FEEDBACK_PREFIX)) {
                ...
                if (!y) {
                  ...
                  if (n) {
                    var r = {
                      ...
                      headers: (0, o.default)(n.headers || {}, function (e) {
                        return e.join(', ')
                      }),
                      body: e,
                    }
                    t(''.concat(_).concat(n.xhrId), r)
                  }
                }
              }),
              (0, i.default)(p, 'setRequestHeader', function (e, t) {
                if (!y) {
                  var n = g.get(p)
                  n && ((n.headers = n.headers || {}), (n.headers[e] = n.headers[e] || []), n.headers[e].push(t))
                }
              })
            var m = {
              readystatechange: function () {
                if (!y && 4 === p.readyState) {
                  var e = g.get(p)
                  if (!e) return
                  if (r(''.concat(_).concat(e.xhrId))) return
                  var t,
                  ...
                  try {
                    switch (p.responseType) {
                      case 'json':
                        t = l._shouldCloneResponse ? JSON.parse(JSON.stringify(p.response)) : p.response
                        break
                      case 'arraybuffer':
                      case 'blob':
                        t = p.response
                  ...
                  if (v && i.body instanceof Blob) {
                    ...
                    u.readAsText(i.body),
                      (u.onload = function () {
                        try {
                          i.body = JSON.parse(u.result)
                        } catch (e) {}
                        n(''.concat(_).concat(e.xhrId), i)
                      })
                  } else n(''.concat(_).concat(e.xhrId), i)
                }
              },
            }
            return (
              Object.keys(m).forEach(function (e) {
                p.addEventListener(e, m[e])
              }),
              p
            )
          }),
          (XMLHttpRequest.prototype = h.prototype),
          ['UNSENT', 'OPENED', 'HEADERS_RECEIVED', 'LOADING', 'DONE'].forEach(function (e) {
            XMLHttpRequest[e] = h[e]
          }),
          function () {
            ;(y = !0), (XMLHttpRequest = h)
          }
        )
      })
    var o = r(n(3)),
  ...
  function (e, t, n) {
    ...
    ;(function (n) {
      ...
      ;(r.report = (function () {
          ...
          if (!t || r.collectWindowErrors) {
            for (var u in n)
              if (n.hasOwnProperty(u))
                try {
                  n[u].apply(null, [e].concat(i.call(arguments, 2)))
                } catch (e) {
                  o = e
                }
            if (o) throw o
        ...
        function p(t, n, o, i, s) {
          if (f) r.computeStackTrace.augmentStackTraceWithInitialElement(f, n, o, t), v()
          else if (s) d(r.computeStackTrace(s), !0)
          else {
            var l,
              p = { url: n, line: o, column: i },
              h = void 0,
              g = t
            if ('[object String]' === {}.toString.call(t)) (l = t.match(a)) && ((h = l[1]), (g = l[2]))
            ;(p.func = u), d({ name: h, message: g, url: c(), stack: [p] }, !0)
          }
        ...
        (r.computeStackTrace = (function () {
          function e(e) {
            if (void 0 !== e.stack && e.stack) {
              for (
                ...
                } else if ((t = i.exec(a[l])))
                  n = { url: t[2], func: t[1] || u, args: [], line: +t[3], column: t[4] ? +t[4] : null }
                else {
                  if (!(t = o.exec(a[l]))) continue
                  n = {
                    url: t[3],
                    func: t[1] || u,
                    args: t[2] ? t[2].split(',') : [],
                ...
                !n.func && n.line && (n.func = u), s.push(n)
              }
              return s.length
                ? (s[0].column || void 0 === e.columnNumber || (s[0].column = e.columnNumber + 1),
                  { name: e.name, message: e.message, url: c(), stack: s })
                : null
            }
          }
          function t(e, t, n, r) {
          ...
          function n(e, i) {
            for (
              ...
              if (v !== o && v !== r.report) {
                if (
                  ...
                  v.name ? (s.func = v.name) : (a = l.exec(v.toString())) && (s.func = a[1]),
                  void 0 === s.func)
                )
                  try {
            ...
            i && f.splice(0, i)
            var h = { name: e.name, message: e.message, url: c(), stack: f }
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.captureMessage = function (e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
          ...
          o = {
            exceptionType: r ? 'CONSOLE' : 'MESSAGE',
            message: t,
      ...
      (t.captureException = function (e, t) {
        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : {},
          ...
          o = r || i.default.computeStackTrace(t),
          a = {
        ...
        c(a, n)
        var s = { _stackTrace: (0, u.default)(o) }
        e.addEvent(
          'lr.core.Exception',
          function () {
            return a
    ...
    function c(e, t) {
      if (t) {
        for (var n = 0, r = ['level', 'logger']; n < r.length; n++) {
          var o = r[n],
            i = t[o]
          a(i) && (e[o] = i.toString())
        }
        for (var u = 0, c = ['tags', 'extra']; u < c.length; u++) {
          for (var s = c[u], l = t[s] || {}, f = {}, d = 0, p = Object.keys(l); d < p.length; d++) {
            var v = p[d],
              h = l[v]
            a(h) && (f[v.toString()] = h.toString())
          }
          e[s] = f
        }
      }
  ...
  function (e, t, n) {
    ...
    var r = n(0)
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = void 0)
    var o = (0, r(n(18)).default)({ sdkVersion: 'script' })
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function () {
        var e,
          ...
          r = t.sdkVersion,
          a = void 0 === r ? '2.2.1' : r,
          c = (0, o.default)(t, ['enterpriseServer', 'sdkVersion']),
          s = 'https://cdn.logrocket.io'
        if ('script' === a)
          try {
        ...
        else (s = 'https://cdn.lr-in.com'), (e = 'https://r.lr-in.com')
        var p = c.sdkServer || n,
          v = c.ingestServer || n || e,
          h = (0, i.default)(function () {
            ...
            v &&
              ...
              p
                ...
                : (e.src = ''.concat(s, '/logger-1.min.js')),
              (e.async = !0),
              document.head.appendChild(e),
              (e.onload = function () {
                'function' == typeof window._LRLogger
                  ? h.onLogger(new window._LRLogger({ sdkVersion: a }))
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function () {
        ...
        if ('undefined' != typeof navigator && 'ReactNative' === navigator.product) throw new Error(i)
    ...
    var o = r(n(21)),
      i = 'LogRocket does not yet support React Native.',
      u = function () {
        return {
          init: function () {},
          uninstall: function () {},
  ...
  function (e, t, n) {
    'use strict'
    var r = n(0)
    Object.defineProperty(t, '__esModule', { value: !0 }), (t.default = t.MAX_QUEUE_SIZE = void 0)
    var o = r(n(5)),
      i = r(n(6)),
      u = r(n(1)),
      a = r(n(4)),
    ...
    var v = function () {
        var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
          t = e.ingestServer,
          n = (0, a.default)(e, ['ingestServer'])
        return t ? p({ serverURL: ''.concat(t, '/i'), statsURL: ''.concat(t, '/s') }, n) : n
      },
      h = (function () {
        function e() {
          var t = this
              ...
              t[e] = function () {
                ...
                t.addEvent(
                  ...
                  function () {
                    ...
                    return (
                      'error' === e && n.shouldAggregateConsoleErrors && s.Capture.captureMessage(t, r[0], {}, !0),
                      { logLevel: e.toUpperCase(), args: r }
                    )
                  },
          ...
          (0, i.default)(e, [
            {
              ...
              value: function (e, t) {
                ...
                this._run(function (o) {
                  o.addEvent(e, t, p(p({}, n), {}, { timeOverride: r }))
                })
              },
            },
            {
            ...
            },
            {
              ...
              value: function (e) {
                ...
                if (!this._isInitialized) {
                  var n = t.shouldAugmentNPS,
                    r = void 0 === n || n,
                    o = t.shouldParseXHRBlob,
                    i = void 0 !== o && o
                  this._installed.push((0, s.registerExceptions)(this)),
                    this._installed.push((0, c.default)(this, { shouldAugmentNPS: !!r, shouldParseXHRBlob: !!i })),
        ...
        var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : { isReactNative: !1 },
          ...
          d = function (e) {
            ...
            if ('object' === (0, i.default)(e) && null != e) {
              ...
              ;(n !== Object.prototype && null !== n) || (t = JSON.stringify(e))
            }
            if (t && t.length && t.length > 4096e3 && 'string' == typeof t) {
              var r = t.substring(0, 1e3)
              return ''.concat(
                r,
            ...
            e.addEvent('lr.network.RequestEvent', function () {
              ...
              if (c) {
                ...
                if ('undefined' != typeof document && 'function' == typeof document.createElement) {
                  ...
                  ;(v.href = c.url), (p = v.href)
                }
                return {
                  reqId: t,
                  url: p,
                  headers: (0, s.default)(c.headers, function (e) {
                    return ''.concat(e)
                  }),
                  body: d(c.body),
                  method: r,
                  referrer: c.referrer || void 0,
                  mode: c.mode || void 0,
                  credentials: c.credentials || void 0,
                }
              }
              return (l[t] = !0), null
            })
          ...
          v = function (t, n) {
            ...
            e.addEvent('lr.network.ResponseEvent', function () {
              ...
              return p
                ...
                : { reqId: t, status: o, headers: {}, body: null, method: r }
            })
          },
          h = function (t) {
            return e.isDisabled || !0 === l[t]
          },
          g = (0, u.default)({ addRequest: p, addResponse: v, isIgnored: h }),
          y = (0, c.default)({
            addRequest: p,
            addResponse: v,
            isIgnored: h,
      ...
      (t.default = function (e) {
        ...
        return u.default.register({
          request: function (e) {
            ...
            var a
            if ('undefined' != typeof Request && r[0] instanceof Request) {
              var s
              try {
                s = r[0].clone().text()
              } catch (e) {
              ...
              a = s.then(
                function (e) {
                  return c(c({}, l(r[0])), {}, { body: e })
                },
                function (e) {
                  return c(c({}, l(r[0])), {}, { body: 'LogRocket fetch error: '.concat(e.message) })
                }
              )
            } else a = Promise.resolve(c(c({}, l(r[1])), {}, { url: ''.concat(r[0]), body: (r[1] || {}).body }))
            return a.then(function (n) {
              return (i[e] = n.method), t(''.concat(o).concat(e), n), r
            })
          },
          ...
          response: function (e, t) {
            var u
            if (r(''.concat(o).concat(e))) return t
            try {
              u = t.clone().text()
            } catch (e) {
              u = Promise.resolve('LogRocket fetch error: '.concat(e.message))
            }
            return (
              u
                .catch(function (e) {
                  if (!('AbortError' === e.name && e instanceof DOMException)) throw e
                })
                .then(function (r) {
                  var u = { url: t.url, status: t.status, headers: s(t.headers), body: r, method: i[e] }
                  delete i[e], n(''.concat(o).concat(e), u)
                }),
              t
            )
          },
          responseError: function (e, t) {
            var r = { url: void 0, status: 0, headers: {}, body: ''.concat(t) }
            return n(''.concat(o).concat(e), r), Promise.reject(t)
          },
        })
      })
    var o = r(n(1)),
        ...
        (function (e) {
          ...
          return (
            e.forEach(function (e, n) {
              t[n] ? (t[n] = ''.concat(t[n], ',').concat(e)) : (t[n] = ''.concat(e))
            }),
            t
          )
        })(e),
    ...
    function a(e, t) {
      ...
      return (
        ...
        (s = s.then(function (t) {
          ...
          ;(0, i.setActive)(!1)
          try {
            n = e.apply(void 0, (0, o.default)(t))
          } catch (e) {
            r = e
          }
          if (((0, i.setActive)(!0), r)) throw r
          return n
        })),
        n.forEach(function (e) {
          var n = e.response,
                ...
                if (e.fetch && e.Promise) {
                  ...
                  ;(e.fetch =
                    ...
                    function () {
                      ...
                      return a.apply(void 0, [t, n++].concat(r))
                    })),
                    r && (e.fetch.polyfill = r)
                }
              })(window)),
            u.push(e),
            function () {
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function (e, t) {
        ...
        return e && t && e.substring(n, n + t.length) === t
      }),
      (e.exports = t.default)
  },
  function (e, t, n) {
      ...
      (t.default = function (e) {
        var t = new i.default({
            captureException: function (t) {
              u.captureException(e, null, null, t)
            },
          }),
          n = function (t) {
            e.addEvent('lr.core.Exception', function () {
        ...
        return (
          ...
          function () {
            window.removeEventListener('unhandledrejection', n), t.uninstall()
          }
        )
      })
    var i = o(n(34)),
                  ...
                  value: function (e, t, n) {
                    ...
                    function o() {
                      var o = [],
                        i = arguments.length,
                        u = !e || (e && !1 !== e.deep)
                      for (n && l(n) && n.apply(this, arguments); i--; )
                        o[i] = u ? r.wrap(e, arguments[i]) : arguments[i]
                      try {
                        return t.apply(this, o)
                      } catch (t) {
                        throw (r._ignoreNextOnError(), r.captureException(a.default.computeStackTrace(t), e), t)
                      }
                    }
                  ...
                  value: function () {
                    ...
                    function n(t) {
                      return function (n, r) {
                        ...
                        var u = o[0]
                        return l(u) && (o[0] = e.wrap(u)), t.apply ? t.apply(this, o) : t(o[0], o[1])
                      }
                    }
                    function r(n) {
                      var r = p[n] && p[n].prototype
                      r &&
                        r.hasOwnProperty &&
                        ...
                        (d(
                          ...
                          function (t) {
                            return function (n, r, o, i) {
                              ...
                              return t.call(this, n, e.wrap(r, void 0, undefined), o, i)
                            }
                          },
                          t
                        ),
                        d(
                          ...
                          function (e) {
                            return function (t, n, r, o) {
                              try {
                                n = n && (n.__lr_wrapper__ ? n.__lr_wrapper__ : n)
                              } catch (e) {}
  ...
  function (e, t, n) {
    ...
    Object.defineProperty(t, '__esModule', { value: !0 }),
      (t.default = function (e) {
        var t = []
        return (
          ['log', 'warn', 'info', 'error', 'debug'].forEach(function (n) {
            t.push(
              (0, i.default)(console, n, function () {
                for (var t = arguments.length, r = new Array(t), i = 0; i < t; i++) r[i] = arguments[i]
                e.addEvent('lr.core.LogEvent', function () {
                  var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                    i = t.isEnabled
                  return ('object' === (0, o.default)(i) && !1 === i[n]) || !1 === i
                    ? null
                    : ('error' === n && t.shouldAggregateConsoleErrors && u.Capture.captureMessage(e, r[0], {}, !0),
                      { logLevel: n.toUpperCase(), args: r })
                })
              })
            )
          }),
                  ...
                  try {
                    ...
                    e.addEvent('lr.redux.ReduxAction', function () {
                      var e = null,
                        n = null
                      try {
                        ;(e = r(l.getState())), (n = u(t))
                      } catch (e) {
                        console.error(e.toString())
                      }
                      return e && n ? { storeId: d, action: n, duration: c, stateDelta: e } : null
                    })
                  }
                  if (n) throw n
                  return o
                ...
                try {
                  ...
                  e.addEvent('lr.redux.ReduxAction', function () {
                    var e = null,
                      o = null
                    try {
                      ;(e = r(t.getState())), (o = a(u))
                    } catch (e) {
                      console.error(e.toString())
                    }
                    return e && o ? { storeId: n, action: o, duration: f, stateDelta: e } : null
                  })
                }
                if (c) throw c
                return s
