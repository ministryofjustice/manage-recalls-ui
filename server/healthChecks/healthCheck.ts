...
import { serviceCheckFactory } from './serviceCheckFactory'
...
const apiChecks = [
  ...
  service('manageRecallsApi', `${config.apis.manageRecallsApi.url}/health`, config.apis.manageRecallsApi.agent),
