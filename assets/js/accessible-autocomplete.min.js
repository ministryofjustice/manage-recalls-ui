  ...
  return (function (n) {
        ...
        w = function (e, t, n) {
          ...
          for (r in (s && (n = t), n))
            (i = ((o = !a && f && f[r] !== undefined) ? f : n)[r]),
              (u = p && o ? _(i, m) : c && 'function' == typeof i ? _(Function.call, i) : i),
              f && g(f, r, i, e & w.U),
              d[r] != i && y(d, r, u),
              c && h[r] != i && (h[r] = i)
        }
    ...
    function (e, t, n) {
        ...
        if (('className' === t && (t = 'class'), 'key' === t));
          ...
          if ('style' === t) {
            ...
            ;(t = t.toLowerCase().substring(2)),
              r ? n || e.addEventListener(t, d, u) : e.removeEventListener(t, d, u),
            ...
            null == r || !1 === r
              ? a
                ...
                : e.removeAttribute(t)
              : 'function' != typeof r &&
                (a ? e.setAttributeNS('http://www.w3.org/1999/xlink', t.toLowerCase(), r) : e.setAttribute(t, r))
          }
        else e.className = r || ''
      }
      function d(e) {
      ...
      function D(e, t, n, r, o) {
        ...
        if (((null != t && 'boolean' != typeof t) || (t = ''), 'string' == typeof t || 'number' == typeof t))
          return (
            e && e.splitText !== undefined && e.parentNode && (!e._component || o)
              ? e.nodeValue != t && (e.nodeValue = t)
              : ((i = document.createTextNode(t)), e && (e.parentNode && e.parentNode.replaceChild(i, e), F(e, !0))),
            (i['__preactattr_'] = !0),
            i
          )
        var a = t.nodeName
              ...
              (function S(e, t, n, r, o) {
                ...
                if (0 !== m)
                  for (var g = 0; g < m; g++) {
                    ...
                    null != w
                      ? (d++, (f[w] = _))
                      : (b || (_.splitText !== undefined ? !o || _.nodeValue.trim() : o)) && (p[v++] = _)
                  }
                if (0 !== y)
                  for (var g = 0; g < y; g++) {
                    ;(s = t[g]), (l = null)
                    ...
                    ;(l = D(l, s, n, r)),
                      ...
                      l &&
                        l !== e &&
                        l !== a &&
                        (null == a ? e.appendChild(l) : l === a.nextSibling ? k(a) : e.insertBefore(l, a))
                  }
                var x, O, C
      ...
      function U(e, t, n, r, o) {
        e._disable ||
          ...
          (e.props = t),
          (e._disable = !1),
          0 !== n && (1 !== n && !1 === E.syncComponentUpdates && e.base ? a(e) : V(e, 1, o)),
          e.__ref && e.__ref(e))
      }
      function V(e, t, n, r) {
        if (!e._disable) {
          ...
          if (
            (e.constructor.getDerivedStateFromProps &&
              ((s = M(M({}, s), e.constructor.getDerivedStateFromProps(a, s))), (e.state = s)),
            d &&
              ((e.props = c),
              (e.state = p),
              (e.context = f),
              2 !== t && e.shouldComponentUpdate && !1 === e.shouldComponentUpdate(a, s, l)
                ? (y = !0)
            ...
            ;(o = e.render(a, s, l)),
              ...
              d && e.getSnapshotBeforeUpdate && (g = e.getSnapshotBeforeUpdate(c, p))
            var _,
              b,
              w = o && o.nodeName
              ...
              (u = m),
                ...
                (m || 1 === t) &&
                  ...
                  (b = (function B(t, n, r, o, i, u) {
                    P++ ||
                      ((j = null != i && i.ownerSVGElement !== undefined), (L = null != t && !('__preactattr_' in t)))
                    var a = D(t, n, r, o, u)
          ...
          for (
            !d || n
              ? A.unshift(e)
              : y || (e.componentDidUpdate && e.componentDidUpdate(c, p, g), E.afterUpdate && E.afterUpdate(e));
      ...
      M(g.prototype, {
        setState: function (e, t) {
          this.prevState || (this.prevState = this.state),
            (this.state = M(M({}, this.state), 'function' == typeof e ? e(this.state, this.props) : e)),
      ...
      var b = { h: r, createElement: r, cloneElement: i, Component: g, render: _, rerender: f, options: E }
      t['default'] = b
    },
    function (e, t) {
        ...
        (e.exports = function (e, t, n, r) {
          ...
          o && (a(n, 'name') || u(n, 'name', t)),
            e[t] !== n &&
              ...
              e === i ? (e[t] = n) : r ? (e[t] ? (e[t] = n) : u(e, t, n)) : (delete e[t], u(e, t, n)))
    ...
    function (e, t, n) {
      ...
      e.exports = function (e) {
        ...
        return (
          o(e) &&
            ('function' != typeof (t = e.constructor) || (t !== Array && !o(t.prototype)) || (t = undefined),
        ...
        return (
          ...
          (t.handleComponentBlur = function (e) {
            var t,
              ...
              o = n.query,
              i = n.selected
            this.props.confirmOnBlur ? ((t = e.query || o), this.props.onConfirm(r[i])) : (t = o),
              this.setState({
                focused: null,
          ...
          (t.handleOptionClick = function (e, t) {
            ...
            this.props.onConfirm(n),
              this.setState({ focused: -1, hovered: null, menuOpen: !1, query: r, selected: -1, validChoiceMade: !0 }),
              this.forceUpdate()
          }),
              ...
              (0, $.createElement)(
                ...
                K &&
                  (0, $.createElement)(
                    'span',
                    null,
                    (0, $.createElement)('input', { className: W, readonly: !0, tabIndex: '-1', value: K })
                  ),
                (0, $.createElement)(
                  'input',
                  X(
                ...
                (0, $.createElement)(
                  ...
                  P && (0, $.createElement)('li', { className: q + ' ' + q + '--no-results' }, p())
                ),
                (0, $.createElement)('span', { id: Q, style: { display: 'none' } }, v())
              )
            )
          }),
          e
    ...
    function (e, t, r) {
      ...
      e.exports =
        ...
        function (e, t) {
          var n
          return (
            null !== e ? ((s[l] = o(e)), (n = new s()), (s[l] = null), (n[a] = e)) : (n = c()),
            t === undefined ? n : i(n, t)
          )
        }
    },
